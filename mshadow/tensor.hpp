 ...
 *
 *  For STL style tensor, see tensor_container.hpp
...
struct Stream {
  ...
  // for GPU, the actual implementation will be specialized in tensor_gpu-inl.hpp
  /*!
